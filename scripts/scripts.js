...
// Запрос базы данных (универсальная)
...
try {
    ...
    const createCard = ({ id, preview, cost, brand, name, sizes }) => {
        ...
        const li = document.createElement('li'); // создаем елемент
        li.classList.add('goods__item'); // добавляем класс
        ...
        return li; // возвращаем елемент
    };

    const renderGoodsList = data => {
        goodList.textContent = ''; // чистим карточки
